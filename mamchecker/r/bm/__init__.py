...
from mamchecker.hlp import Struct, norm_expr, norm_rounded, equal_0 as equal
import sympy
...
def calc(g):
    ...
    return [sympy.sstr(Ep),sympy.sstr(E),sympy.sstr(K),sympy.sstr(p),sympy.sstr(el), rG, mp]
